...
public interface ProveedorRepository extends JpaRepository<Proveedor, Integer> {
    ...
    List<Proveedor> findByStatusTrueAndTipoProductoIdTipoProducto(Integer idTipoProducto);

    // Buscar proveedores activos por sucursal
    List<Proveedor> findByStatusTrueAndSucursalIdSucursal(Integer idSucursal);
