...
public class ProveedorProductoController {
    ...
    public ResponseEntity<List<ProveedorProductoDTO>> getAllProveedorProductos() {
        List<ProveedorProductoDTO> proveedorProductos = proveedorProductoService.getAllProveedorProductos();
        return new ResponseEntity<>(proveedorProductos, HttpStatus.OK);
    }
